...
public class Main {
	...
	public static void main(String[] args) {
		...
		motor.setMotorHacmi(14100);
		// motor.saseNo = "M446A";
		motor.setYakitTuketimi(10);

		// System.out.println(motor.getMotorHacmi() + " " + motor.getYakitTuketimi());
		// System.out.println(motor.toString());
		System.out.println(motor); // toString metodunu otomatik cagirir.
		...
		// otomobil2.getMotor().setMotorHacmi(1400); // olmayan bir motora bir motor
		// hacmi atamaya calistim ** Null pointer exception hatasi
