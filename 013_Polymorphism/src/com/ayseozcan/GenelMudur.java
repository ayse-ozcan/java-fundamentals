...
public class GenelMudur {
	...
	public DaireBaskani[] getBagliDaireBaskanlari() {
		return bagliDaireBaskanlari;
	}
	
	public void setBagliDaireBaskanlari(DaireBaskani[] bagliDaireBaskanlari) {
		this.bagliDaireBaskanlari = bagliDaireBaskanlari;
	}
