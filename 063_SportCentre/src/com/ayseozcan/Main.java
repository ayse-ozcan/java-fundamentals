...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("Toplam : " + kaan.getAdSoyad() + " ın harcadığın kalori:" + kaan.getToplamHarcananKalori());
		...
		System.out.println("Toplam : " + zeynep.getAdSoyad() + " ın harcadığın kalori:" + zeynep.getToplamHarcananKalori());
