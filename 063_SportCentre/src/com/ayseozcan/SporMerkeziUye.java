...
public class SporMerkeziUye {
	...
	public void sporYap(String yapilacakHareket, int kacDakikaYapildi) {
		...
		// System.out.println(kacDakikaYapildi + " dk.lık " + yapilacakHareket + " spor
		// harekti sonucu yakılan kalori: " + harcananKalori);
	...
	public void tumSporKayitlariniGoster() {
		System.out.println("\n*****************************************************");
		System.out.println();
		System.out.println("Üye no: " + this.uyeNo + " Ad soyad: " + this.adSoyad + " Agğırlık: " + this.agirlik);
